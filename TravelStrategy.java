...
import org.springframework.beans.factory.annotation.Value; // ADDED THIS
...
public class TravelStrategy {
    ...
    // --- REFACTOR: Pull the max fare from application.properties ---
    @Value("${fare.max}")
    ...
    public Consumer<Double> anyWhereInZoneOneStrategy = chargeableAmount -> {
        ...
        rule.addZonePair(new ZonePair(Zone.ONE, Zone.ONE));
    ...
    public RuleCollection loadAllBusinessRules() {
        ...
        // --- REFACTOR: Using injected value instead of hardcoded 3.20 ---
        anyThreeZoneStrategy.accept(maxFare);
